...
<div class="edit_menu" class="disnone">
    ...
    <div class="layui-col-sm12">
        <table class="layui-table center" id="sonTable">
            <thead>
            <tr>
            ...
            <tbody class="safe-data">
                <tr>
                    <td><input type="text" id="handle-total" name="handle-total" maxlength="8" placeholder="请输入数量"></td>
                    <td><input type="text" id="raise-total" name="raise-total" maxlength="8" placeholder="请输入数量"></td>
                    <td><input type="text" id="relief-total" name="relief-total" maxlength="8" placeholder="请输入数量"></td>
                </tr>
            </tbody>
        </table>
