    ...
    <table class="layui-table center" id="table">
        ...
        <tr>
            <th ms-for="(index,item) in @list" :attr="{colspan:(item.children==0?1:item.children),rowspan:(item.children==0?2:1)}"
                :class="(item.active? 'active':'')" ms-click="active($event,index,1)">
                {{item.name}}
            </th>
        </tr>
        <tr>
    ...
    <div class="containerBox marT-10">
        <div class="layui-row" style="line-height:30px">
            ...
            <div class=" layui-col-xs11">
                <input type="text" style="margin: 10px;width:280px" name="title" lay-verify="required" placeholder="请输入搜索字段" ms-keyup="search"
                       ms-duplex="@keywords" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-row" style="line-height:30px">
            <div class="layui-col-xs1" style="padding: 10px;">
            ...
            <ul class="layui-col-xs11">
                <li class="item" ms-for="(index,item) in @type" ms-click="selcetType($event,index)" :class="[(item.active?'active':'')]">
                    {{item.class_name}}
                </li>
            </ul>
        </div>
        <div class="layui-row" style="line-height:30px">
            ...
            <ul class="layui-col-xs11">
                <li class="li-item" ms-for="(index,item) in @typeList" ms-click="add($event,index,@typeList)" :class="(item.active?'active2':'')">
                    {{item.name}}
                </li>
            </ul>
        </div>
    ...
    <div class="containerBox marT-10">
        <div class="layui-row">
                ...
                <div class="layui-form-item marT-10 layui-form">
                    ...
                    <div class="layui-input-block" style="margin-left:120px">
                        <div class="layui-col-xs4 ">
                            <input name="title" id="startAge" ms-keyup="setAgeTitle($event)" style="text-align:center" ms-duplex="@startAge"
                                   type="number" required lay-verify="required" placeholder="起始年龄" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-col-xs4 " style="padding:10px">
                            <hr class="hr"/>
                        </div>
                        <div class="layui-col-xs4 ">
                            <input name="title" id="endAge" ms-keyup="setAgeTitle($event)" style="text-align:center" ms-duplex="@endAge" type="number"
                                   required lay-verify="required" placeholder="结束年龄" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
            </div>
            <div class="layui-row marT-10" style="max-width:400px;position:relative">
                ...
                <div class="layui-input-block" style="margin-left:120px">
                    <input type="text" name="title" id="ageTitle" required ms-duplex="@ageTitle" lay-verify="required" placeholder="请输入命名"
