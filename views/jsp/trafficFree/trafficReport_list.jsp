...
<div class="tableBox">
    ...
    <hr>
    <div style="text-align:center;"><span style="color: #FF3333;">${sysArea.name}</span>老年人交通出行优待统计表</div>
    ...
    <table class=" layui-table center" id="table">
        ...
        <tr>
            <th rowspan="2">市（州）</th>
            <th colspan="2">为老年人乘坐公共交通工具实行免票</th>
        </tr>
        <tr>
         	<th>数量（次）</th>
            <th>总金额</th>
...
<script type="text/javascript">
    ...
    $("#dowExcel").on("click", function () {
        ...
        if (version != null && "" != version) {
            window.location.href = '<%=basePath%>trafficReport/dowExcel.do?version=' + version + '&level=${pd.level}';
        } else {
    ...
    $("#tbody").on("click", ".address", function () {
        ...
        if(level!=2){
        	 var title = $(this).text();
             parent.addTab(title + "老年人交通出行优待统计表", "trafficReport/listInfo.do?area_code=" + szqy_code + "&area_name=&year=" + '${pd.year}' + "&nd=" + '${pd.nd}');
        }
    });
