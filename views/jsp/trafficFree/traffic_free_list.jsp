...
<div class="tableBox">
	<div class="operationBox">
	   <form action="list.do?xzqh=${pd.xzqh_code}" class="layui-form" method="post" name="Form" id="Form">
	     ...
	     <shiro:hasPermission name="traffic:info:add">
	    ...
	    <table class="layui-table center" id="table">
	        ...
	        <c:choose>
	            <c:when test="${not empty listExpand}">
	                <shiro:hasPermission name="traffic:info:select">
	                ...
	                <shiro:lacksPermission name="traffic:info:select">
	                    <tr>
...
<script type="text/javascript">
    ...
    layui.use('laypage', function () {
        ...
        laypage.render({
            ...
            jump: function (obj, first) {
                if (!first) {
                    window.location.href = "<%=basePath%>trafficFree/list.do?currentPage=" + obj.curr + '&id=' + '${id}' + '&keywords=' + '${keywords}';
                }
            }
        });
    });
    ...
    $("#add").on("click", function () {
          ...
          parent.parent.layer.open({
              title: "新增",
              type: 2,
              content: '<%=basePath%>trafficFree/toAdd.do?id=' + '${id}' + '&currentPage=' + ${page.currentPage},
              area: ["800px", "550px"]
          });
    });
    ...
    function edit(id, TYPE) {
        ...
        parent.parent.layer.open({
            title: msg,
            type: 2,
            content: '<%=basePath%>trafficFree/goEdit.do?id=' + id + '&currentPage=' + ${page.currentPage} +'&TYPE=' + TYPE,
            area: ["800px", "550px"]
        });
    }
    ...
    function del(id) {
        parent.parent.layer.confirm("是否删除此数据?", {
            ...
            var url = "<%=basePath%>trafficFree/delete.do?id=" + id;
            $.get(url, function (data) {
                if ("success" == data.result) {
                    window.location.href = '<%=basePath%>trafficFree/list.do?currentPage=${page.currentPage}' + '&id=' + '${id}';
